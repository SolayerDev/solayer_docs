...
<Accordion title="How can a dApp become a Delegate on Solayer?">
Any dApp on Solana can become a Delegate by using Solayer's Delegation contract to create their own Solayer AVS LST. They can then change their AVS's metadata and start receiving delegations of sSOL.
</Accordion>
