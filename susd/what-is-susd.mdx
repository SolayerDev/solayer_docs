...
To build on this momentum, we’ve created sUSD in collaboration with [OpenEden](https://openeden.com) — a pioneering yield-bearing, restaking stablecoin designed to enhance utility within the Solana network. 
