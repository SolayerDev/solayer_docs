...
<Accordion title="1. What is sUSD?">
  sUSD is the first yield-bearing restaking stablecoin on Solana, developed in collaboration with OpenEden Labs. It is designed to offer a steady 4-5% yield through T-bill investments ([see associated risks](https://docs.openeden.com/treasury-bills-vault/risks)) while also being used to secure exogenous Actively Validated Services (exoAVSs) on Solayer.
</Accordion>
<Accordion title="2. How does sUSD generate yield?">
  sUSD is inherently yield-bearing, generating a 4-5% yield from T-bills. You can read further [here](https://openeden.com). 
</Accordion>
