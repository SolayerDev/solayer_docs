...
QLPs subscribe for TBILL tokens by depositing USDC into the TBILL vault of OpenEden. In exchange, the QLPs receive TBILL tokens, which they self-custody in their private accounts, ensuring they retain control and ownership over their TBILL tokens. The QLPs will redeem their TBILL tokens for USDC from the TBILL Vault when processing withdrawals.
 ...
 2. Deposit the USDC to receive OpenEden's T-BILL tokens.
 3. Hold these T-BILL tokens securely in their designated vault.
